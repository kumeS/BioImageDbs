...
DataImport_2d_seg(WIDTH = WIDTH00, HEIGHT = HEIGHT00,
                  ...
                  Original_path=Original_path,
                  GroundTruth_path=GroundTruth_path,
                  FileName=paste0(DataPath, "/", DataFolder, DataFolder_Name),
                  Binary=TRUE)
...
ImageView2D(Dat$Train, Interval=0.8, 
            Name=paste0(DataFolder, DataFolder_Name, "_train_dataset"))
filesstrings::file.move(files=paste0(DataFolder, DataFolder_Name, "_train_dataset.gif"),
                        destinations=DataPath, overwrite = TRUE)
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0007_Mouse_Kidney_MultiScale"
DataFolder_Name <- "_High_Mitochondria_4dTensor"
Original_path="High_Mitochondria_OriginalData"
GroundTruth_path="High_Mitochondria_GroundTruth"
WIDTH00 <- 1024 ; HEIGHT00 <- 1024 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0007_Mouse_Kidney_MultiScale"
DataFolder_Name <- "_High_Nucleus_4dTensor"
Original_path="High_Nucleus_OriginalData"
GroundTruth_path="High_Nucleus_GroundTruth"
WIDTH00 <- 1024 ; HEIGHT00 <- 1024 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0007_Mouse_Kidney_MultiScale"
DataFolder_Name <- "_Middle_Fibroblast_4dTensor"
Original_path="Middle_Fibroblast_OriginalData"
GroundTruth_path="Middle_Fibroblast_GroundTruth"
WIDTH00 <- 1024 ; HEIGHT00 <- 1024 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0007_Mouse_Kidney_MultiScale"
DataFolder_Name <- "_Middle_Podocyte_4dTensor"
Original_path="Middle_Podocyte_OriginalData"
GroundTruth_path="Middle_Podocyte_GroundTruth"
WIDTH00 <- 1024 ; HEIGHT00 <- 1024 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0007_Mouse_Kidney_MultiScale"
DataFolder_Name <- "_Low_Glomerulus_4dTensor"
Original_path="Low_Glomerulus_OriginalData"
GroundTruth_path="Low_Glomerulus_GroundTruth"
WIDTH00 <- 1024 ; HEIGHT00 <- 1024 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0007_Mouse_Kidney_MultiScale"
DataFolder_Name <- "_Low_Uriniferous_Tubule_4dTensor"
Original_path="Low_Uriniferous_Tubule_OriginalData"
GroundTruth_path="Low_Uriniferous_Tubule_GroundTruth"
WIDTH00 <- 1024 ; HEIGHT00 <- 1024 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
#Set parameters
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0008_Human_NB4_2D"
DataFolder_Name <- "_Cell512_4dTensor"
Original_path="Cell_OriginalData"
GroundTruth_path="Cell_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataFolder <- "EM_id0008_Human_NB4_2D"
DataFolder_Name <- "_Mito512_4dTensor"
Original_path="Mito_OriginalData"
GroundTruth_path="Mito_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0008_Human_NB4_2D"
DataFolder_Name <- "_Nuc_crop512_4dTensor"
Original_path="Nuc_crop512_OriginalData"
GroundTruth_path="Nuc_crop512_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0008_Human_NB4_2D"
DataFolder_Name <- "_Nuc512_4dTensor"
Original_path="Nuc_OriginalData"
GroundTruth_path="Nuc_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1

#Convert TIF to PNG
if(F){
path <- "./BioImageDbs_02_Dataset_v02/EM_id0008_Human_NB4_2D/01_Training/Nuc_OriginalData"
...
path <- "./BioImageDbs_02_Dataset_v02/EM_id0008_Human_NB4_2D/02_Testing/Nuc_OriginalData"
Img <- dir(path, pattern=".tif")
for(n in 1:length(Img)){
  #n <- 1
  Img00 <- EBImage::readImage(paste0(path, "/", Img[n]), type="tiff")
...
Path02 <- "01_Training"
Original_path="All_Cell_OriginalData"
GroundTruth_path="All_Cell_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
#Metadata
Meta.Rds <- data.frame(
  Title=paste0(Path01, "_", sub("_OriginalData", "_4dtensor", Original_path), ".Rds"),
  Description="wrote in excel",	
  BiocVersion="3.14",
  Genome="NA",
  SourceType="PNG",
...
Path01 <- "EM_id0008_Human_NB4_2D"
Path02 <- "01_Training"
Original_path="All_Mito_OriginalData"
GroundTruth_path="All_Mito_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
Path01 <- "EM_id0008_Human_NB4_2D"
Path02 <- "01_Training"
Original_path="All_Nuc_OriginalData"
GroundTruth_path="All_Nuc_GroundTruth"
WIDTH00 <- 512 ; HEIGHT00 <- 512 ; CHANNELS01 <- 1 ; CHANNELS02 <- 1
...
### 03_Wide / WideEM_NB4_097 / crop_x1024 / crop_x2048
...
#Set parameters
DataPath <- "./BioImageDbs_02_Dataset_v02"
DataFolder <- "EM_id0009_MurineBMMC"
DataFolder_Name <- "_MultiLabels_4dTensor"
