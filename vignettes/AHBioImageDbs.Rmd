...
date: "`r Sys.Date()`"
graphics: no
package: AHBioImageDbs, knitr, magick
output:
...
environment, and it is prepared in a format suitable for the analytical package. 
...
The ordering of the array dimensions is corresponded to the channels_last format
...
The ordering of the array dimensions is corresponded to the channels_last format
(default) in R/Keras. The input shape of 4D array is to be batch, height, width, 
...
# About the imaging dataset and its metadata in AHBioImageDbs

For this dataset in AHBioImageDbs, the published open data was used as 
following; 

1) For the cellular ultra-microstructures, electron microscopy-
based imaging data of mouse brain 
(ex. EM_id0001_Brain_CA1_hippocampus_region_5dTensor.Rda) [5-6], Drosophila brain 
(ex. EM_id0002_Drosophila_brain_region_5dTensor.Rda) [7-8], mouse B myeloma cell 
line J558L (ex. EM_id0003_J558L_4dTensor.Rda) [9], and The primary human T cell 
