...
date: "`r Sys.Date()`"
graphics: no
package: ExperimentHub, knitr, magick
output:
...
```{r query-mouse}
qr <- query(eh, c("BioImageDbs", ".Rda"))
qr
#BioImageDbs_image_Dat <- qr[[5]]
```
...
cells on a flat glass (ex. LM_id0001_DIC_C2DH_HeLa_4dTensor.Rda) [10], 
human glioblastoma-astrocytoma U373 cells on a polyacrylamide substrate 
(ex. LM_id0002_PhC_C2DH_U373_4dTensor.Rda) [10] and GFP-GOWT1 mouse stem 
cells (ex. LM_id0003_Fluo_N2DH_GOWT1_4dTensor.Rda) [11] were used.
